...
$config['web_title']		= "Public Participation Management Platform";
$config['web_footer']		= "COPYRIGHT PPMP &copy; 2018.";
$config['owner_name']		= "PPMP";
...
|
*/
$config['encryption_key'] = 'ppmp12345';
